...
sports |>
  ...
  labs(title = "Distribution of Total Revenue (in millions)",
       x = "Total revenue (in millions)", y = "Count")
```
...
sports <- sports |>
  ...
  mutate(total_exp_mill = total_exp_menwomen / 1000000)

sports |>
  ggplot(aes(x = total_exp_mill)) +
  geom_histogram(binwidth = 5) +
  labs(title = "Distribution of Total Expenditure (in millions)",
       x = "Total expenditure (in millions)", y = "Count")
```
```{r}
sports |>
...
sports |>
  ...
  labs(title = "Total Revenue vs. Total Expenditure",
       x = "Total expenditure (in millions)", y = "Total revenue (in millions)")
```
